// อันใหม่: ยิง API จริงด้วย getMovie(id) แทน data.js ข้อดีที่ดีกว่าอันเก่าคือได้ชื่อภาษาไทยและแนวหนังที่ถูกต้อง (data.js มีแต่ชื่ออังกฤษและแนวหนังเป็นรหัส)
...
// อันเก่า: ใช้ data.js เป็นแหล่งข้อมูล ไม่ต้องยิง API จริง
// import { useParams, Link } from 'react-router-dom';
// import ReviewForm from '../components/ReviewForm';
